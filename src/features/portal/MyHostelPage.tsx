    ...
    <div style={{ maxWidth: 720, width: '100%', margin: '0 auto' }}>
      ...
      >
        <div>
          ...
          <Text type="secondary">Your block, room and roommates.</Text>
        </div>
        {!notLinked && (
          <Button
            icon={<ReloadOutlined />}
        ...
        <Card styles={{ body: { padding: token.paddingLG } }} style={{ boxShadow: token.boxShadowTertiary }}>
          {isError ? (
            <Alert
              type="warning"
              showIcon
              message="Couldn't load your hostel details"
            ...
            <HostelAllocationView
              ...
              emptyText="You haven't been allocated a hostel room yet"
            />
          )}
        </Card>
      )}
